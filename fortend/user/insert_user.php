                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="user_password" id="user_password" name="user_password" required="required" placeholder="รหัสผ่าน" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO `tb_user`( `user_fullname`, `user_position`, `user_email`, `user_phone`, `user_department`, `user_code`, `user_username`, `user_password`)";
                        $sql .= " Values ('$user_fullname','$user_position','$user_email','$user_phone','$user_department','$user_code','$user_username','$user_password')";
