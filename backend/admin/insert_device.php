            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql = "INSERT INTO `tb_device` (`user_code` , `device_asset_tag`, `device_serialnumber`, `device_description`, `device_location`, `device_dmanufacturer`, `device_installed_status`, `device_dname`, `device_comment`, `device_type`, `device_model`, `device_datetime`)";
                        $sql .= " VALUES ('$user_code','$device_asset_tag', '$device_serialnumber', '$device_description', '$device_location', '$device_dmanufacturer', '$device_installed_status', '$device_dname', '$device_comment', '$device_type', '$device_model', '$device_datetime')";
