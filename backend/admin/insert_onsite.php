                ...
                <div class="x_content">
                    ...
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="email" id="onsite_email" name="onsite_email" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="password" id="onsite_password" name="onsite_password" minlength="7" required="required" placeholder="รหัสผ่าน" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sql_check_duplicate = "SELECT * FROM tb_onsite WHERE onsite_fullname='$onsite_fullname' OR onsite_email='$onsite_email' OR onsite_username='$onsite_username'";
                        ...
                        $sql = "INSERT INTO `tb_onsite`(`onsite_fullname`,`onsite_phone`, `onsite_email`,`onsite_username`,`onsite_password`,`onsite_department`, `onsite_position`, `onsite_datetime`)";
                        $sql .= "Values ('$onsite_fullname','$onsite_phone','$onsite_email','$onsite_username','$onsite_password','$onsite_department','$onsite_position','$onsite_datetime')";
